...
export const CURRICULUM: Part[] = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { slug: "tcp-egress", title: "Beyond REST: Direct TCP Egress", blurb: "Not everything is HTTP — grant a raw host:port allow rule for non-REST traffic, no L7 inspection.", minutes: 6, hasLab: true },
